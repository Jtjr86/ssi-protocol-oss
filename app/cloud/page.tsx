        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 border border-white/20">
            ...
            <div className="text-center mt-8">
              ...
              >
                <Link href="https://github.com/Jtjr86/ssi-protocol/blob/main/PILOT_README.md" target="_blank">
                  View Deployment Guide <ArrowRight className="ml-2" size={20} />
                </Link>
              </Button>
              <p className="text-sm text-white/70 mt-4">
                Or reach out via <a href="https://github.com/Jtjr86/ssi-protocol/issues" className="underline" target="_blank" rel="noopener noreferrer">GitHub Issues</a> to discuss
              </p>
            </div>
          </div>
        </div>
